...
function showEditPricingModal(pricing) {
  ...
  const search_price
  document.getElementById("edit-price-id").value = pricing.id;
  document.getElementById("edit-category-name").value = pricing.category_name;
  document.getElementById("edit-size-name").value = pricing.size_name;
