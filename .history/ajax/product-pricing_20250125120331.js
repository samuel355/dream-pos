...
function showEditPricingModal(pricing) {
  ...
  const search_price_id = document.getElementById("edit-price-id");
  const search_cate_nam = document.getElementById("edit-category-name")
  const search_size = document.getElementById("edit-size-name");
  const search_price_value = document.getElementById("edit-price")

  if(search_price_id){
    search_price_id.value = pricing.id
  }
  if(search_cate_nam){
    search_cate_nam.value = pricing.category_name;
  }
  if(search_size){
    search_size.value = pricing.size_name;
  }
  if(search_price_value){
    search_price_value.value = pricing.price;
  }
