...
<body>
  ...
  <div class="modal fade" id="edit-pricing-modal" tabindex="-1" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Product Pricing</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
                ...
                <div class="content">
                    <div class="page-header">
                        <div class="page-title">
                            ...
                            <h6>Modify product size and price</h6>
                        </div>
                    </div>

                    <div class="card">
                        <div class="card-body">
                            <form id="edit-product-pricing-form" class="row" method="post">
                                <input type="hidden" id="edit-price-id" name="price_id">
                                <div class="col-lg-4 col-12">
                                    <div class="form-group">
                                        <label>Category</label>
                                        <input type="text" id="edit-category-name" readonly class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Size Name</label>
                                        <input type="text" id="edit-size-name" readonly class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
