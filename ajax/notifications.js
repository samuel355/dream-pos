...
function displayNotifications(notifications) {
                  ...
                  <div class="media d-flex">
                      <div class="media-body d-flex flex-grow-1" style="justify-content: space-between; font-weight: bold">
                          <div class="noti-details">
                              New order from <span class="noti-title">${notification.customer_name}</span>
                              <br>Amount: <span class="noti-title">GHS ${parseFloat(notification.total_amount).toFixed(2)}</span>
                              <p>ITEMS: <span style="margin-left: 5px">${notification.items}</span>  </p>
                          </div>
                          <p class="noti-time">
  ...
  if (notifications.length === 0) {
      html = '<li class="notification-message"><div class="media d-flex"><div class="media-body flex-grow-1"><p class="text-center">No new notifications</p></div></div></li>';
  }
