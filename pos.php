                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="customer-name" id="customer-name" placeholder="Customer full name">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Phone Number</label>
                                            <input type="text" name="customer-phone" id="customer-phone" placeholder="Customer contact">
                                        </div>
                                    </div>
                                </div>
                            </div>
